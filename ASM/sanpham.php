					...
					<div class="product">
						...
						<div class="price-box">
							...
							if ($row['product_name'] > 0) {
								echo '
									<span class="special-price">' . $row['product_sale'] . '₫</span>
						...
						<div class="information">
							<p>Nhà sản xuất: <?php echo '<a href="danhsach.php?brand-id=' . $row['brand_id'] . '">' . $row['brand_name'] . '</a>'; ?></p>
							<p>Dòng sản phẩm: <?php echo '<a href="danhsach.php?category-id=' . $row['category_id'] . '">' . $row['category_name'] . '</a>'; ?></p>
						</div>
					...
					<div class="product-tab">
						<div class="product-tab-nav">
							<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
								<li class="nav-item">
									<a class="nav-link active" id="product-info-tab" data-toggle="tab" href="#product-info" role="tab" aria-controls="product-info" aria-selected="true">Thông tin sản phẩm</a>
								</li>
								<li class="nav-item">
									<a class="nav-link" id="shipping-tab" data-toggle="tab" href="#shipping" role="tab" aria-controls="shipping" aria-selected="false">Hình thức giao hàng</a>
								</li>
								<li class="nav-item">
									<a class="nav-link" id="rating-tab" data-toggle="tab" href="#rating" role="tab" aria-controls="rating" aria-selected="false">Đánh giá sản phẩm</a>
								</li>
							</ul>
							<div class="tab-content" id="myTabContent">
								<div class="tab-pane fade show active" id="product-info" role="tabpanel" aria-labelledby="product-info-tab">Thông tin sản phẩm</div>
								<div class="tab-pane fade" id="shipping" role="tabpanel" aria-labelledby="shipping-tab">Hình thức giao hàng</div>
