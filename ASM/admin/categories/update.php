...
if(isset($_POST['submit'])){
    $sql = "update categories set category_name='".$_POST['category_name']."', category_update='".date('Y-m-d H:i:s')."' where category_id=".$_POST['category_id'];
          ...
          <div class="">
              <form action="#" method="POST">
                  <div class="form-group">
                    <input type="text" name="category_id" class="form-control" value="<?php echo $category['category_id']; ?>" hidden>
                  </div>
                  <div class="form-group">
